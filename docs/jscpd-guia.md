...
candidatos a duplicação
    ↓
prompts/03-duplicacoes-redundancias.md
    ↓
...
Ferramentas determinísticas também podem fornecer candidatos a código morto dependendo da linguagem e do ecossistema. O mesmo princípio vale: use a ferramenta para gerar evidências e o prompt `02-codigo-morto.md` para avaliar contexto e risco.
