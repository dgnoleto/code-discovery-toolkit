...
Use este prompt preferencialmente **depois de uma análise determinística**. Para repositórios compatíveis, consulte [`docs/jscpd-guia.md`](../deterministic/jscpd-guia.md). A ferramenta encontra candidatos; a IA avalia contexto, falsos positivos e relevância.
