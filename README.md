...
Abra a pasta [`prompts/`](prompts/), copie o conteúdo de [`01-mapeamento-inicial.md`](workflows/manual/01-mapeamento-inicial.md) e cole no seu assistente de IA (Claude, ChatGPT, Cursor, etc.) fornecendo o `graphify.md` gerado no Passo 1.
...
Use o prompt [`04-relatorio-final.md`](workflows/manual/04-relatorio-final.md) para consolidar todos os achados em um único documento estratégico ([`templates/04-relatorio-final-template.md`](templates/04-relatorio-final-template.md)) e enviar automaticamente os débitos técnicos para o Jira ou Azure Boards do seu time.
...
* **Como usar no Antigravity**: Carregue o [`workflows/agentic/AGENTS-discovery-template.md`](workflows/agentic/AGENTS-discovery-template.md) como diretiva de sistema. O Antigravity executa a varredura em subagentes paralelos e conecta-se via MCP ao Jira ou Azure DevOps.
...
* **Claude Code**: Copie [`workflows/agentic/AGENTS-discovery-template.md`](workflows/agentic/AGENTS-discovery-template.md) para a raiz como **`CLAUDE.md`**. Ao abrir no terminal, ele assumirá o perfil de Discovery somente leitura.
* **Cursor / Windsurf**: Copie [`workflows/agentic/AGENTS-discovery-template.md`](workflows/agentic/AGENTS-discovery-template.md) para a raiz como **`.cursorrules`** (ou `.cursor/rules/discovery.md`).

### 🔄 3. Engenharia de Loops Agênticos, MCP & Guardiões (Avançado)
Para repositórios gigantes (300+ arquivos), consulte o **[Guia de Engenharia de Loops Agênticos](workflows/agentic/engenharia-de-loops-guia.md)**. Ele ensina a configurar:
...
O toolkit separa a metodologia de discovery da forma de executá-la:

| Workflow | Quando usar |
| :--- | :--- |
| [**Manual**](workflows/manual/README.md) | Quer máxima portabilidade e controle passo a passo, usando prompts com qualquer assistente. |
| [**Determinístico**](workflows/deterministic/README.md) | Quer ferramentas encontrando evidências antes da IA, reduzindo comparações probabilísticas desnecessárias. |
| [**Agêntico**](workflows/agentic/README.md) | Quer executar a Engenharia de Loops, varreduras módulo a módulo, gates e integrações MCP. |

Os três modos compartilham os mesmos princípios, templates e decisão humana. Eles podem ser combinados sem duplicar a metodologia.
...
| :--- | :--- | :--- |
| [`workflows/manual/`](workflows/manual/) | Prompts para execução manual e agnóstica | Não |
| [`workflows/deterministic/`](workflows/deterministic/) | Detecção baseada em ferramentas antes da interpretação por IA | Opcional |
| [`workflows/agentic/`](workflows/agentic/) | Engenharia de Loops, AGENTS, gates e execução agêntica | Opcional |
| [`docs/`](docs/) | Guia de [Metodologia](docs/metodologia.md), [Glossário de IA](docs/glossario.md), [Graphify](docs/graphify-guia.md), [Contexto de Negócio](docs/contexto-negocio-guia.md), [Engenharia de Loops & MCP](workflows/agentic/engenharia-de-loops-guia.md), [jscpd / análise determinística](workflows/deterministic/jscpd-guia.md), [Azure DevOps](docs/azure-devops-guia.md) e [Jira](docs/jira-guia.md) | Não |
...
| [`workflows/agentic/AGENTS-discovery-template.md`](workflows/agentic/AGENTS-discovery-template.md) | Template de comportamento seguro para agentes de IA | Não |
